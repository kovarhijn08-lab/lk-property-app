...
- [x] **E2E 2: Создание и видимость** (PASS — 2026-01-31, localhost/emulator)
  - **Действие**: Создать Property "P1.5 Test".
  - **Ожидаемый результат**: Объект появляется в списке мгновенно.
  - **Факт**: объект создаётся и после reload виден в списке.
  - **Примечание**: при старте эмулаторов были нестабильные ошибки соединения Firestore/Token; после стабилизации видимость восстановилась.
- [ ] **E2E 3: Финансы и Метрики** (BLOCKED — 2026-01-31, localhost/emulator)
  ...
  - **Факт**: при попытке открыть Tenant/Chat в Manage → Tenant произошёл краш (Firestore internal assertion). До формы транзакций не дошли.
  - **Блокер**: нестабильность Firestore Emulator (internal assertion) + нет очевидной кнопки “Add/Log Transaction” в Manage → Finance.
- [ ] **E2E 4: Безопасность Impersonation** (BLOCKED — 2026-01-31)
...
- [ ] **E2E 5: Устойчивость сессии** (BLOCKED — 2026-01-31)
...
- [ ] **E2E 6: Регистрация жильца без инвайта** (BLOCKED — 2026-01-31)
...
- [ ] **E2E 7: Использование чужого инвайта** (BLOCKED — 2026-01-31)
...
- [ ] **E2E 8: Доступ к объектам по UID (UID isolation)** (BLOCKED — 2026-01-31)
...
- [ ] **E2E 9: Скрытые инвайты** (BLOCKED — 2026-01-31)
...
- [ ] **TP 1: Единый портал** (BLOCKED — 2026-01-31)
...
- [ ] **TP 2: Messaging** (BLOCKED — 2026-01-31)
...
- [ ] **TP 3: Maintenance** (BLOCKED — 2026-01-31)
...
- [ ] **TP 6: Quick Actions Navigation** (BLOCKED — 2026-01-31)
